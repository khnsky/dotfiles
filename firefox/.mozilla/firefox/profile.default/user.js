...
user_pref("devtools.theme", "dark");                        // dark theme
...
// tor uplift
user_pref("privacy.firstparty.isolate", "true");            // isolate identity sources
...
// don't track:
user_pref("browser.send_pings", false);                     // clicks
user_pref("dom.battery.enabled", false);                    // battery status
user_pref("dom.event.clipboardevents.enabled", false);      // copy paste cut events
user_pref("media.navigator.enabled", false);                // camera / mic
